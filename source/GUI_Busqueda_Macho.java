...
public class GUI_Busqueda_Macho extends GUI_Dialog {
...
// Constructores
    public GUI_Busqueda_Macho(GUI_Dialog p, Datos base) {
        super(p);
        parent=p;
        baseDatos=base;
        lista=Busqueda.buscarEjemplaresMachos( baseDatos.getListaEjemplares() );
        indice=0;
        crearGUI();
    }

    public GUI_Busqueda_Macho(GUI_Dialog p, Datos base, String n) {
        super(p);
        parent=p;
        baseDatos=base;
        lista=Busqueda.buscarEjemplaresMachos( baseDatos.getListaEjemplares() );
...
//----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    private void nuevo() {
        final int TIPO=Constantes.SEXO_MACHO;
...
//----------------------------------------------------------------------------------------------------------------------------------------------
    private void crearGUI() {
        armarPaneles();
        setTitle("Buscar ejemplar macho");
        setSize(302,306);
        setResizable(false);
