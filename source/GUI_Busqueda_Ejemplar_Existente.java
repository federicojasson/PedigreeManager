...
public class GUI_Busqueda_Ejemplar_Existente extends GUI_Dialog {
...
// Constructores
    public GUI_Busqueda_Ejemplar_Existente(GUI_Frame p, Datos base) {
        super(p);
        parent=p;
        baseDatos=base;
        lista=baseDatos.getListaEjemplares();
        indice=0;
        crearGUI();
    }
