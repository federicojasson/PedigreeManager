...
public class GUI_Busqueda_Persona_Existente extends GUI_Dialog {
...
// Constructores
    public GUI_Busqueda_Persona_Existente(GUI_Frame p, Datos base) {
        super(p);
        parent=p;
        baseDatos=base;
        lista=baseDatos.getListaContactos();
        indice=0;
        crearGUI();
    }
...
//----------------------------------------------------------------------------------------------------------------------------------------------
    public Persona obtenerElementoSeleccionado() {
        return contacto;
    }
//----------------------------------------------------------------------------------------------------------------------------------------------
    private void aceptar() {
        ...
        contacto=(Persona)lista.getElemento(indice+filaSeleccionada);
