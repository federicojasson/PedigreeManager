...
public class GUI_Mensaje_Error extends GUI_Dialog {
...
// Constructores
    public GUI_Mensaje_Error(GUI_Frame p, String texto) {
        super(p);
        parent=p;
        title="Error";
        lineas=texto.split("\n");
    ...
    public GUI_Mensaje_Error(GUI_Dialog p, String texto) {
        super(p);
        parent=p;
        title="Error";
        lineas=texto.split("\n");
    ...
    public GUI_Mensaje_Error(String texto) {
        super();
        title="Error";
        lineas=texto.split("\n");
        crearGUI();
    ...
    public GUI_Mensaje_Error(GUI_Frame p, String texto, String t) {
        super(p);
        parent=p;
        title=t;
        lineas=texto.split("\n");
    ...
    public GUI_Mensaje_Error(GUI_Dialog p, String texto, String t) {
        super(p);
        parent=p;
        title=t;
        lineas=texto.split("\n");
...
//----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    private JPanel armarPanelIcono() {
        final String ICONO_ERROR=Constantes.ARCHIVO_IMAGEN_ICONO_ERROR;
        
        JLabel labelIcono=new JLabel( new ImageIcon( getClass().getResource(ICONO_ERROR) ) );
